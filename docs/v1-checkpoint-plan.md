...
Current production-readiness blocker: apply the lean baseline in `docs/ops-dashboard-alerts-v1.md` in the deployed monitoring stack and verify live signal flow.
