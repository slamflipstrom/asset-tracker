...
2. Set secrets for both apps (adjust as needed):
   - `fly secrets set --app asset-ws DATABASE_URL=... SUPABASE_URL=... SUPABASE_SERVICE_ROLE_KEY=... CRYPTO_PROVIDER_NAME=mobula CRYPTO_PROVIDER_API_KEY=...`
   - `fly secrets set --app asset-worker DATABASE_URL=... SUPABASE_URL=... SUPABASE_SERVICE_ROLE_KEY=... CRYPTO_PROVIDER_NAME=mobula CRYPTO_PROVIDER_API_KEY=...`
